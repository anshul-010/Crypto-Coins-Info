...
function Banner() {
  ...
  const item = trandingCoin.map((coin)=>{
    ...
    return (<Link to={`/coin/${coin.id}`} className='carouselItem' >
  <img
          src={coin?.image}
          alt={coin.name}
          height="80"
  ...
  return (
    <div className='banner'  >
        <Heading as='h1' style={{ fontWeight:"bolder",fontSize:"40px",fontFamily:"serif" ,color:"white",textAlign:"center",padding:"100px 0 20px" }}>Hot List</Heading>
        <div className='text'>
        <Heading lineHeight='tall' style={{fontFamily:"serif",fontSize:"27px"}} >

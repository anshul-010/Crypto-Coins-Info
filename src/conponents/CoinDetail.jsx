  ...
  return (
    <div className='coinContainer' >
      ...
      <img
        ...
        <div style={{ width:"100%",padding:"10px",paddingBottom:"10px",textAlign:"justify"}} >
          <Text className='description' >{singleCoin?.description.en.split(". ")[0]}</Text>
        </div>
        <div className='marketData'>
            <span className='market' style={{display:"flex"}}>Rank:  {numberWithCommas(+singleCoin?.market_cap_rank)}</span>
        </div>
        <div className='marketData'>
            <span className='market' style={{display:"flex"}}>Current Price: {symbol}{" "}
              {numberWithCommas(
                +singleCoin?.market_data.current_price[currency.toLowerCase()]
              )}</span>
        <div className='marketData'>
            <span className='market' style={{display:"flex"}}>Market Cap: {symbol}{" "}
              {numberWithCommas(
